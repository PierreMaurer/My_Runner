...
struct sprite_game *sprite_init_third(struct sprite_game sprite)
{
    ...
    sfSprite_setTextureRect(sprite_game->obstacle, sprite.rect_game->obstacle_rect);
    sfSprite_setPosition(sprite_game->obstacle, sprite.posSprite->obstacle_pos);
    ...
    sfSprite_setTextureRect(sprite_game->road, sprite.rect_game->road_rect);
...
struct sprite_game *sprite_init_four(struct sprite_game sprite)
{
    ...
    sfSprite_setTextureRect(sprite_game->skill_building_bg, sprite.rect_game->skill_rect);
    sfSprite_setTexture(sprite_game->skill_building_bg, texture_4, sfTrue);
    sprite_game = sprite_init_fift(*sprite_game);
    return sprite_game;
}
...
struct sprite_game *sprite_init_fift(struct sprite_game sprite)
{
    ...
    sfSprite_setTextureRect(sprite_game->far_building_bg, sprite.rect_game->far_rect);
    ...
    sfSprite_setTextureRect(sprite_game->character, sprite.rect_game->chara_rect);
    sfSprite_setPosition(sprite_game->character, sprite.posSprite->character_position);
    return sprite_game;
}